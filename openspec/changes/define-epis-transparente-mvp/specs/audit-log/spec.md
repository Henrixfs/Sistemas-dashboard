...
El sistema SHALL registrar automáticamente en el log de auditoría toda operación crítica: creación, publicación, corrección, anulación de movimientos y reemplazo de comprobantes.
...
El sistema MUST conservar de forma inmutable los registros de auditoría generados por las operaciones críticas y no permitirá que los usuarios los modifiquen o eliminen mediante la aplicación.
